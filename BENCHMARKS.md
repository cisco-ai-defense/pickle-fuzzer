...
This document contains performance benchmarks for `pickle-whip` using criterion.
...
# Or explicitly:
pickle-whip --protocol 3 --min-opcodes 60 --max-opcodes 300 output.pkl
```

### For Maximum Coverage
```bash
# Use larger opcode ranges (still fast!)
pickle-whip --min-opcodes 200 --max-opcodes 1000 output.pkl
```
